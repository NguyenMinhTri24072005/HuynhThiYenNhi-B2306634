...
if ($result->num_rows > 0) {
  ...
  // Cần load lại dữ liệu hoặc dùng data_seek(0) để đưa con trỏ về đầu
$result->data_seek(0); 
  $result->data_seek(0);
  $result->data_seek(0);
  echo "<b>Cách 6: Sử dụng fetch_object()</b><br>";
  while($obj = $result->fetch_object()) {
      // Truy cập dữ liệu như thuộc tính của đối tượng
      echo "ID: " . $obj->id . " - Sinh viên: " . $obj->fullname . "<br>";
  }
